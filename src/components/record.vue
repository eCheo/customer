            ...
            <div class="r_left">
                ...
                <div style="position:absolute;top:0;left:10%;width:30%;height:93%;margin-top:1%;">
                    ...
                    <div class="r_top1">
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.corporateName" @on-blur="addContract('corporateName')" @on-change="inputChange" :readonly="readonly3">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.entryName" @on-change="inputChange" @on-blur="addContract('entryName')" :readonly="readonly3">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.corporateAddress" :disabled="disabled" @on-blur='addContract("corporateAddress")' :readonly="readonly">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.projectAddress" :disabled="disabled" @on-blur='addContract("projectAddress")' :readonly="readonly">
                    ...
                    <div class="r_top1">
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.pickUp" :disabled="disabled" @on-blur='addContract("pickUp")' :readonly="readonly">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.docking" :disabled="disabled" @on-blur='addContract("docking")' :readonly="readonly">
            ...
            if ((corporateName == "" || entryName == "") || (corporateName != "" || entryName != "")) {// 公司名字和项目名字空不空都要调接口
                this.$axios.get('/api/front/record/findByConditionList.json', {
                    ...
                    if (this.recordDto.corporateName == "" || this.recordDto.entryName == "") {//公司名字和项目名称有一个为空都等于false
                        ...
                        this.disabled = true;
                        this.disabled1 = true;
                    } else if (res.data.data.length == 0) { // 没有相匹配的能填剩下的
                        this.isShow = false;
                        this.buttonShow1 = true;
                        this.disabled = false;
                        this.disabled1 = false;
                    } else if (res.data.data.length > 0) { // 有相匹配的不能填剩下的
                        this.isShow = true;
                        this.buttonShow1 = false;
                        this.disabled = true;
                        this.disabled1 = true;
