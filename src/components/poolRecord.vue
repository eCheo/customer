    ...
    <div class="minR">
        <div class="total">
                ...
                <div style="position:absolute;top:0;left:12%;width:30%;height:93%;margin-top:1%;">
                    ...
                    <div class="r_top1">
                        <div class="r_one">
                            ...
                            <div class="one_right">
                                ...
                                <DatePicker readonly   v-model="overdueTime" :options="options3" type="datetime" format="yyyy-MM-dd" style="float:left;width:58%;"></DatePicker>
                            </div>
                        </div>
                    </div>
                    <div class="r_top1">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input v-model="recordDto.entryName" readonly @on-focus="hides3 = true" @on-blur="addContract('entryName')" >
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <label>媒体形式</label>
                                <Select size="small" disabled @on-change="addContract('mediaForm')" multiple v-model="mediaFormRecord" style="width:83.5%;height:28px;margin-bottom:5px;border:1px solid #01C675;border-radius:5px;margin-left:-5px;">
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input readonly v-model="recordDto.corporateAddress" @on-blur="addContract('corporateAddress')" >
                        ...
                        <div class="r_one1">
                            <div class="one_left1">
                                <Input readonly v-model="recordDto.projectAddress" @on-focus="hides2 = true" @on-blur="addContract('projectAddress')" >
                    ...
                    <div class="r_but">
                        <div class="r_top2">
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.contactName" @on-blur='addContract("contactName")' >
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.position" @on-blur='addContract("position")' >
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.phone" @on-blur='addContract("phone")' >
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.qq" @on-blur='addContract("QQ")' >
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.weiXin" @on-blur='addContract("weiXin")' >
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input readonly v-model="contract.landLine" @on-blur='addContract("landLine")'>
                    ...
                    <div class="r_top1">
                            ...
                            <div class="one_left2">
                                <label>网络对接人</label>
                                <Select disabled v-model="recordDto.pickUp" filterable   @on-blur='addContract("pickUp")'>
                        ...
                        <div class="r_one1">
                            <div class="one_left2">
                                <label>网络对接部门</label>
                                <Select disabled v-model="recordDto.docking" filterable   @on-blur='addContract("docking")'>
            ...
            <div style="padding-top:3%">
                ...
                <div class="textarea">
                    <Input readonly v-model="recordDto.remarks" maxLength="500" style="width:360px;" type="textarea"  :rows="8"></Input>
                </div>
                <div class="pen">
            ...
            <div class="ivu-modal-mask">
                <Card dis-hover class="hide_div">
                    ...
                    <Row class-name="r_box1">
                        <Col>
                        <Input readonly v-model="reject" type="textarea" placeholder="驳回信息"></Input>
                        </Col>
                    </Row>
        ...
        <div class="v-transfer-dom" v-show="hides3">
            <div class="ivu-modal-mask">
                <Card dis-hover class="hide_div">
                    ...
                    <Input readonly type="text" placeholder="项目名称1" v-model="entryName1" @on-change="entryNameSelect(entryName1)" ></Input>
                    ...
                    <Input readonly type="text" placeholder="项目名称2" v-model="entryName2" @on-change="entryNameSelect1(entryName2)" ></Input>
                    <div style="height:20px;">
                        <p style="color:#FA150A;" v-show="isHides1">
                            该项目已备案
                        </p>
                    </div>
                    <Input readonly type="text" placeholder="项目名称3" v-model="entryName3" @on-change="entryNameSelect2(entryName3)" ></Input>
                    <div style="height:20px;">
        ...
        <div class="v-transfer-dom" v-show="hides2">
            <div class="ivu-modal-mask">
                <Card dis-hover class="hide_div">
                    ...
                    <Input readonly type="text" placeholder="项目地址1" v-model="corporateAddress1" ></Input>
                    <br> <br>

                    <Input readonly type="text" placeholder="项目地址2" v-model="corporateAddress2" ></Input>
                    <br> <br>
                    <Input readonly type="text" placeholder="项目地址3" v-model="corporateAddress3" ></Input>
                    <br><br>
                    <Row>
                        <Col span="4" offset="14">
                        <Button type="ghost" @click="hide">取消</Button>
