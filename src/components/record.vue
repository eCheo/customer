                ...
                <div class="r_left">
                    ...
                    <div style="position:absolute;top:0;left:10%;width:30%;height:93%;margin-top:1%;">
                        ...
                        <div class=" r_top1">
                            <div class="r_one">
                                <div class="one_left">
                                    <Input v-model="time" readonly :readonly="readonly">
                                    <span slot="prepend">备案时间</span>
                                    </Input>
                                </div>
                                <div class="one_right">
                                    <label>到期时间</label>
                                    <DatePicker v-model="overdueTime" type="date" format="yyyy-MM-dd" style="float:left;width:126px;" :readonly="readonly"></DatePicker>
                                </div>
                            </div>
                        </div>
                        <div class="r_top1">
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.corporateName" @on-change="inputChange" :readonly="readonly">
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.corporateAddress" @on-change='changeValue("corporateAddress")' :readonly="readonly">
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.entryName" @on-change="inputChange" :readonly="readonly">
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.projectAddress" @on-change='changeValue("projectAddress")' :readonly="readonly">
                        ...
                        <div class="r_but">
                            <div class="r_top2">
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.contactName" @on-blur='addContract()' @on-change='changeValue("contactName")' :readonly="readonly">
                                ...
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.position" @on-blur='addContract()' @on-change='changeValue("position")' :readonly="readonly">
                                ...
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.phone" @on-blur="addContract" @on-change='changeValue("phone")' :readonly="readonly">
                                ...
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.qq" @on-blur='addContract()' @on-change='changeValue("QQ")' :readonly="readonly">
                                ...
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.weiXin" @on-blur='addContract()' :readonly="readonly">
                                ...
                                <div class="r_one1">
                                    <div class="one_left1">
                                        <Input v-model="contract.landLine" @on-blur='addContract()' :readonly="readonly">
                        ...
                        <div class="r_top1">
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.pickUp" @on-change='changeValue("pickUp")' :readonly="readonly">
                            ...
                            <div class="r_one1">
                                <div class="one_left1">
                                    <Input v-model="recordDto.docking" @on-change='changeValue("docking")' :readonly="readonly">
                    ...
                    <ul class="but_list">
                        ...
                        <li>
                            <router-link to="/chiefsee">
                                <div class="div_but" v-show="buttonShow">
                                    <img src="/static/img/button_03.png">
                                    <span>
                                        成交
                                    </span>
                        ...
                        <li>
                            <div class="div_but" @click="state" v-show="buttonShow">
                                <img src="/static/img/button_03.png">
                                <span>
                                    提交Filling
                                </span>
                ...
                <div style="padding-top:3%">
                    <div class="cord">
                        <div class="album">
                            ...
                            <Upload ref="upload" :show-upload-list="false" :on-success="handleSuccess" :format="['jpg','jpeg','png','gif']" :max-size="4800000" :before-upload="handleBeforeUpload" multiple type="drag" action="/api/obs/upload.json" style="display: inline-block;width:58px;">
...
export default {
    ...
    beforeUpdate() {
        ...
        if (this.recordStatus == "A_trial" || this.recordStatus == "B_dealApply" || this.recordStatus == "D_dealCut" || this.recordStatus == "E_recordSuccess" || this.recordStatus == "E_deal") {
            this.readonly = true;
